...
<div class="row">
	<div class="col-lg-12">
	    <h2 style="text-align: center">List of Requested Budget</h2>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Request for Budget</h4>
      </div>
      <div class="modal-body">
	  	<form class="role">
	  		<div class="form-group">
				...
				<input name="item" class="form-control" placeholder="item name" />	<br>  			
				<input name="amount" class="form-control" placeholder="requested amount" /><br>
